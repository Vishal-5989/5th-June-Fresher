...
public class EmployeeController {
	...
	public String setCookie(HttpServletRequest request, HttpServletResponse response) {
		Cookie servletCookie = createCookie("user-id", "c2FtLnNtaXRoQGV4YW1wbGUuY29t", 1 * 24 * 60 * 60, true, true, "/", request.getServerName());
	...
	public String deleteCookie(HttpServletRequest request, HttpServletResponse response) {
		Cookie deleteServletookie = createCookie("user-id", null, 0, true, true, "/single-create", request.getServerName());
	...
	public String setCookies(HttpServletRequest request, HttpServletResponse response, @RequestBody Interest interest) throws JsonProcessingException {
		ObjectMapper objectMapper = new ObjectMapper();
		String jsonString = objectMapper.writeValueAsString(interest);
//		System.out.println(jsonString);
		Cookie servletCookie = createCookie("demo-id", jsonString, 1 * 24 * 60 * 60, true, true, "/object-create", request.getServerName());
		response.addCookie(servletCookie);
	...
	private Cookie createCookie(String name, String value, int expiry, boolean isSecure, boolean httpOnly, String path, String domain ) {
